...
from nnunet_sub.experiment_planning.common_utils import split_4d_nifti
from nnunet_sub.paths import (
    nnUNet_raw_data,
    nnUNet_cropped_data,
    preprocessing_output_dir,
)
from nnunet_sub.preprocessing.cropping import ImageCropper
...
def split_4d(
    ...
    output_folder = join(
        nnUNet_raw_data, "Task%03.0d_" % overwrite_task_output_id + task_name
    )
...
def plan_and_preprocess(
    ...
    from nnunet_sub.experiment_planning.experiment_planner_baseline_2DUNet import (
        ExperimentPlanner2D,
    )
    from nnunet_sub.experiment_planning.experiment_planner_baseline_3DUNet import (
        ExperimentPlanner,
    )
