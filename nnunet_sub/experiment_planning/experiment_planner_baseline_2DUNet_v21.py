...
import numpy as np
from nnunet_sub.experiment_planning.common_utils import get_pool_and_conv_props
...
class ExperimentPlanner2D_v21(ExperimentPlanner2D):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlansv2.1_plans_2D.pkl"
        )
    ...
    def get_properties_for_stage(
        ...
        ref = (
            Generic_UNet.use_this_for_batch_size_computation_2D
