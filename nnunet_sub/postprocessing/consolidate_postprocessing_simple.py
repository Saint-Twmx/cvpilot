...
from nnunet_sub.postprocessing.consolidate_postprocessing import consolidate_folds
...
def main():
    argparser = argparse.ArgumentParser(
        usage="Used to determine the postprocessing for a trained model. Useful for "
    ...
    argparser.add_argument(
        ...
        type=str,
        required=True,
        help="U-Net model (2d, 3d_lowres, 3d_fullres or " "3d_cascade_fullres)",
    )
