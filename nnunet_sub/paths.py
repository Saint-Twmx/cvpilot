...
preprocessing_output_dir = fr'{parent_dir}/data/nnUNet_processed/'
base = fr'{parent_dir}/data/nnUNet_raw_data_base/'
network_training_output_dir_base = fr'{parent_dir}/data/nnUNet_result'

if not os.path.exists(preprocessing_output_dir):
    os.makedirs(preprocessing_output_dir)
if not os.path.exists(base):
    os.makedirs(base)
if not os.path.exists(network_training_output_dir_base):
    os.makedirs(network_training_output_dir_base)

# base = (
#     os.environ["nnUNet_raw_data_base"]
#     if "nnUNet_raw_data_base" in os.environ.keys()
#     else None
# )
# preprocessing_output_dir = (
#     os.environ["nnUNet_preprocessed"]
#     if "nnUNet_preprocessed" in os.environ.keys()
#     else None
# )
