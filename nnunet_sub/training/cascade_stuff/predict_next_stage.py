...
from nnunet_sub.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class(
        [join(nnunet_sub.__path__[0], "training", "network_training")],
        trainerclass,
        "nnunet_sub.training.network_training",
    )
