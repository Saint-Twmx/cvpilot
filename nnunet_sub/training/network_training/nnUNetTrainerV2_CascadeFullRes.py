...
import matplotlib
from nnunet_sub.configuration import default_num_threads
from nnunet_sub.postprocessing.connected_components import determine_postprocessing
from nnunet_sub.training.data_augmentation.data_augmentation_moreDA import get_moreDA_augmentation
from nnunet_sub.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset
from nnunet_sub.evaluation.evaluator import aggregate_scores
from nnunet_sub.network_architecture.neural_network import SegmentationNetwork
from nnunet_sub.paths import network_training_output_dir
from nnunet_sub.inference.segmentation_export import save_segmentation_nifti_from_softmax
from batchgenerators.utilities.file_and_folder_operations import *
import numpy as np
from nnunet_sub.training.loss_functions.deep_supervision import MultipleOutputLoss2
from nnunet_sub.training.network_training.nnUNetTrainerV2 import nnUNetTrainerV2
...
class nnUNetTrainerV2CascadeFullRes(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, local_rank, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="nnUNetTrainerV2", fp16=False,distribute_batch_size=False,
                 class_weights=[None, None], loss_F="DC_CE"):
        super().__init__(plans_file, fold, output_folder, dataset_directory,
                         batch_dice, stage, unpack_data, deterministic, fp16, class_weights)
        self.init_args = (plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                          deterministic, previous_trainer, fp16, class_weights)
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            if training:
                # print(f"~~~~~~~~~~~~~~self.folder_with_segs_from_prev_stage: {self.folder_with_segs_from_prev_stage}")
                # print(f'~~~~~~~~~~~~~~/ssd1/xyang/nnUNet/nnUNet_trained_models/nnUNet/3d_lowres/Task502_Aorta/nnUNetTrainerV2_DP__nnUNetPlansv2.1/pred_next_stage')
