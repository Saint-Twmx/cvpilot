...
from nnunet_sub.training.data_augmentation.data_augmentation_insaneDA2 import (
...
from nnunet_sub.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3 import (
...
class nnUNetTrainerV2BraTSRegions_DA3_BD(nnUNetTrainerV2BraTSRegions_DA3):
    def __init__(
        ...
        self.loss = DC_and_BCE_loss(
            {}, {"batch_dice": True, "do_bg": True, "smooth": 0}
        )
