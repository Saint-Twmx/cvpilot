...
from nnunet_sub.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_insaneDA import (
...
class nnUNetTrainerV2_MMS(nnUNetTrainerV2_insaneDA):
    def setup_DA_params(self):
        ...
        self.data_aug_params["elastic_deform_alpha"] = (0.0, 300.0)
