...
from nnunet_sub.training.network_training.network_trainer import NetworkTrainer
...
class nnUNetTrainer(NetworkTrainer):
        ...
        self.loss = DC_and_CE_loss(
            {
                ...
                "smooth": 1e-5,
                "do_bg": False,
                "class_dc_weight": class_weights[0],
            },
    ...
    def preprocess_patient(self, input_files):
        ...
        assert preprocessor_class is not None, (
            "Could not find preprocessor %s in nnunet_sub.preprocessing"
            % preprocessor_name
        )
