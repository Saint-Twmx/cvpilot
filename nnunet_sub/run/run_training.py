...
from nnunet_sub.paths import default_plans_identifier
from nnunet_sub.run.default_configuration import get_default_configuration
from nnunet_sub.run.load_pretrained_weights import load_pretrained_weights
from nnunet_sub.training.cascade_stuff.predict_next_stage import predict_next_stage
from nnunet_sub.training.network_training.nnUNetTrainer import nnUNetTrainer
from nnunet_sub.training.network_training.nnUNetTrainerCascadeFullRes import (
...
def main():
    ...
    if trainer_class is None:
        raise RuntimeError(
            "Could not find trainer class in nnunet_sub.training.network_training"
        )
