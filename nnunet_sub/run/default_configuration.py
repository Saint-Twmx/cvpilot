...
from nnunet_sub.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(
    ...
    search_in=(nnunet_sub.__path__[0], "training", "network_training"),
    base_module="nnunet_sub.training.network_training",
):
    assert network in [
        "2d",
        "3d_lowres",
